...
<section id="faq" class="faq section">
  ...
  <div class="container" data-aos="fade-up">
    ...
    <div class="faq-header text-center mb-5">
      ...
      <p>
        Answers to common questions about membership, savings, loans, and
        services of Our Lady of La Salette Multi-Purpose Cooperative (OLLSMPC).
      </p>
    </div>
    ...
    <div class="accordion faq-accordion" id="faqAccordion">
      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button class="accordion-button" type="button"
            ...
            Who can become a member of OLLSMPC?
          </button>
        </h2>
        <div id="faq1" class="accordion-collapse collapse show">
          <div class="accordion-body">
            Any individual who meets the cooperative’s membership requirements
            and agrees to its policies may apply for membership.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        ...
        <div id="faq2" class="accordion-collapse collapse">
          <div class="accordion-body">
            You may apply by visiting the OLLSMPC office or by completing the
            membership registration form on the official website.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed" type="button"
            ...
            What savings products does OLLSMPC offer?
          </button>
        </h2>
        <div id="faq3" class="accordion-collapse collapse">
          <div class="accordion-body">
            OLLSMPC offers Regular Savings, Special Savings, Time Deposits,
            and Super Special Savings with competitive interest rates.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed" type="button"
            ...
            Are savings and time deposits tax-exempt?
          </button>
        </h2>
        <div id="faq4" class="accordion-collapse collapse">
          <div class="accordion-body">
            Yes. Interests earned from savings and time deposits are tax-exempt
            in accordance with cooperative regulations.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        ...
        <div id="faq5" class="accordion-collapse collapse">
          <div class="accordion-body">
            OLLSMPC offers personal, emergency, and livelihood loans
            designed to support members’ financial needs.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        ...
        <div id="faq6" class="accordion-collapse collapse">
          <div class="accordion-body">
            Loan approval depends on document completeness and loan type,
            but applications are processed as efficiently as possible.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed" type="button"
            ...
            How can I contact OLLSMPC for assistance?
          </button>
        </h2>
        <div id="faq7" class="accordion-collapse collapse">
          <div class="accordion-body">
            You may contact OLLSMPC via phone, email, or by visiting the
            cooperative office during business hours.
          </div>
        </div>
      </div>
