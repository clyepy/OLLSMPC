  ...
  <main class="main">
    ...
    <div class="page-title light-background">
      <div class="container d-lg-flex justify-content-between align-items-center">
        <h1 class="mb-2 mb-lg-0">Staff Details</h1>
        <nav class="breadcrumbs">
          <ol>
            <li><a href="index.php">Home</a></li>
            <li class="current">Staff Details</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
  ...
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    <div class="row">
      ...
      <div class="col-lg-4 order-lg-2">
        <div class="staff-sidebar" data-aos="fade-left" data-aos-delay="200">

          <!-- Profile Card -->
          <div class="staff-card">
            <div class="staff-photo">
              <img src="uploads/team/<?php echo $staff['image']; ?>" class="img-fluid">
            </div>
...
<p><strong>Years of Service:</strong> <?php echo $staff['years_of_service']; ?></p>
<p><strong>Status:</strong> <?php echo $staff['status']; ?></p>
...
<li>
  ...
  <span><?php echo $staff['phone']; ?></span>
</li>
<li>
  <i class="bi bi-geo-alt-fill"></i>
  <span><?php echo $staff['office']; ?></span>
</li>
      ...
      <div class="col-lg-8 order-lg-1">
        <div class="staff-main-content">
          ...
          <div class="staff-header" data-aos="fade-up">
            <h1>Staff Profile</h1>
<p class="staff-intro">
  <?php echo $staff['intro']; ?>
</p>

          </div>

          <!-- Biography -->
          <div class="staff-section" data-aos="fade-up" data-aos-delay="100">
            <h2>Professional Background</h2>
            <p><?php echo nl2br($staff['background']); ?></p>
          </div>
...
<ul class="staff-list">
<?php foreach (explode("\n", $staff['responsibilities']) as $item): ?>
  <li><?php echo $item; ?></li>
<?php endforeach; ?>
</ul>
          ...
          <!-- Qualifications -->
          <div class="staff-section" data-aos="fade-up" data-aos-delay="300">
            <h2>Qualifications & Experience</h2>
<ul class="staff-list">
<?php foreach (explode("\n", $staff['qualifications']) as $item): ?>
  <li><?php echo $item; ?></li>
<?php endforeach; ?>
</ul>
          ...
          <!-- Mission Statement -->
          <div class="staff-section highlight" data-aos="fade-up" data-aos-delay="400">
            <h2>Commitment to Service</h2>
<p><?php echo nl2br($staff['commitment']); ?></p>

          </div>

        </div>
      </div>
      <!-- END STAFF MAIN CONTENT -->
